--Create STUDENT_INFO table with given constraints
...
--Create RESULT table with given constraints 
...
-- Insert Data into Student and Result Table 
...
-- Create DEPARTMENT table with given constraints 
...
--Create PERSON table with given constraints
...
--Insert Data into PERSON and DEPARTMENT Table
...
--Create PUBLISHER table with given constraints
...
--Create AUTHOR table with given constraints 
...
--Create BOOK table with given constraints
...
-- Insert Data into PUBLISHER, AUTHOR and BOOK Table 
