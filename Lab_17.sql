...
CREATE VIEW Salary_EmP1
AS
SELECT * FROM EMPLOYEE
WHERE SALARY < 10000;

SELECT * FROM Salary_EmP1
...
CREATE VIEW FIRST_CONTAINS_VOWELS
AS 
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE '%[AEIOU]%';

SELECT * FROM FIRST_CONTAINS_VOWELS
...
CREATE VIEW NAME_START_M
AS 
SELECT * FROM EMPLOYEE
WHERE FIRSTNAME LIKE 'M%N';

SELECT * FROM NAME_START_M
